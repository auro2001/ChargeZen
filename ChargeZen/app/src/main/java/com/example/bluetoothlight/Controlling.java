...
public class Controlling extends AppCompatActivity {
    ...
    final static String on="O";//on
    final static String off="F";//off
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        On_Off.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                notificationHelper.sendHighPriorityNotification("Charge Full", "Plug Disconnected", Controlling.class);
        ...
        Button plugCard = findViewById(R.id.plgstat);
        Button perCard = findViewById(R.id.percstatus);
        Button heacard = findViewById(R.id.heasat);
        Button tempcard = findViewById(R.id.tempestats);
        Button logout = findViewById(R.id.logoutbtn);

        plugCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        perCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), perActivity.class);
                startActivity(intent);
            }
        });

        heacard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), heaActivity.class);
                startActivity(intent);
            }
        });
